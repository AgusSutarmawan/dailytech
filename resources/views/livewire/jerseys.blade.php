            ...
            <table class="table-fixed w-full">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>{{$jersey->harga}}</td>
                        <td>
                            <button wire:click="edit({{$jersey->id}} )" class="py-1 px-4 text-sm rounded text-blue-500 font-semibold border border-blue-500 hover:text-white font-bold hover:bg-blue-500 hover:border-transparent focus:outline-none">Edit</button></a>
                            <button wire:click="delete({{$jersey->id}} )" class="py-1 px-4 text-sm rounded text-red-500 font-semibold border border-red-500 hover:text-white font-bold hover:bg-red-500 hover:border-transparent focus:outline-none">Delete</button></a>
                        </td>
                    </tr>
                    <?php $id++; ?>
                    @endforeach
